<template>
    <div>
        <section class="max-w-[1060px] min-h-[713px] mx-auto border rounded-2xl mt-16 ">
            <div class=" p-5 md:p-10 flex flex-1 justify-center gap-10">
                <div class="hidden lg:flex flex-1 flex-shrink-0">
                    <img src="https://raw.githubusercontent.com/Quynhhuong150322/DIKO_STUDY_TRAVEL_WEB/main/src/assets/images/Login/loginImg.png"
                        alt="Login" class="object-contain" />
                </div>
                <div class="flex-1 py-10 flex justify-center ">
                    <div class="flex flex-col flex-1 gap-4">
                        ...
                        <form @submit.prevent="submitLogin" class="flex flex-col flex-1 gap-5">
                            <div class="flex flex-col flex-1 gap-1">
                                <label htmlFor="email" class="text-sm font-normal cursor-pointer">
                                    Email
                                </label>
                                <div class="flex items-center">
                                    <input type="email" id="email" v-model='email' placeholder="EasySet24@gmail.com"
                            ...
                            <div class="flex justify-between md:flex-row flex-col gap-2 md:gap-0">
                                <div class="flex gap-3 items-center ">
                                    ...
                                    <label htmlFor="remember" class="text-sm font-normal text-[#112211] cursor-pointer">
                                        Remember Me
                                    </label>
                                </div>
                                <div>
                            ...
                            <button
                                class="text-base font-medium text-white cursor-pointer flex-1 max-h-[48px]  bg-[#07689F] text-center rounded border px-2 py-3 hover:bg-gray-500 cursor-pointer ">login</button>
    ...
    methods: {
        ...
        async submitLogin() {
            try {
                ...
                console.log(resutlLogin);

                resutlLogin.status == 200 ? alert(resutlLogin.data.mess) : alert("Have Error");
